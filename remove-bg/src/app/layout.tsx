...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'BG Remover Team', url: 'https://bg-remover.vercel.app' }],
  metadataBase: new URL('https://bg-remover.vercel.app'), // replace with your domain
  openGraph: {
    ...
    images: [
      {
        url: 'https://bg-remover.vercel.app/og-image.jpg', // add actual og:image
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://bg-remover.vercel.app/og-image.jpg'], // add actual Twitter image
  },
  robots: {
    index: true,
    follow: true,
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        ...
        <link rel="canonical" href="https://bg-remover.vercel.app" />
      </head>
